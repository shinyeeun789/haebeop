                ...
                <div class="col-lg-6">
                    <div class="banner_content text-center">
                        ...
                        <div class="page_link">
                            ...
                            <a href="${path}/notice/detail"> Detail </a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="blog_info text-right">
                            <ul class="blog_meta list">
                                <li><a href="#">${detail.nickname}<i class="ti-user"></i></a></li>
                                <li><a href="#">${detail.regdate}<i class="ti-calendar"></i></a></li>
                                <li><a href="#">${detail.visited} Views<i class="ti-eye"></i></a></li>
                            </ul>
                        </div>
                    </div>
