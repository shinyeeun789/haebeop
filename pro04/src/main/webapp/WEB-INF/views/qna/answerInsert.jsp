                ...
                <div class="col-lg-6">
                    <div class="banner_content text-center">
                        ...
                        <div class="page_link">
                            ...
                            <a href="${path}/qna/answerInsert"> Insert </a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="blog_area single-post-area section_gap">
    <div class="container shadow mb-30 p-5">
        <h1> 답변하기 <i class="fa-solid fa-pencil"></i> </h1>
        <div>
            ...
            <div class="form-group mt-3">
                ...
                <textarea name="content" class="form-control" cols="30" rows="10" readonly>${detail.content}</textarea>
            </div>
        </div>
        <hr>
