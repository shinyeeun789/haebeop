    ...
    <div class="container shadow mb-30 p-5">
        ...
        <form action="${path}/event/edit" method="post">
                    ...
                    <div class="switch-wrap d-flex">
                        <div class="primary-radio">
                            ...
                            <c:if test="${detail.status ne 1}">
                                <input type="radio" id="now" value="1" name="status">
                            </c:if>
                            <label for="now"></label>
                        </div>
                        <p class="ml-2"> 진행 중 </p>
                    ...
                    <div class="switch-wrap d-flex ml-5">
                        <div class="primary-radio">
                            <c:if test="${detail.status eq 0}">
                                <input type="radio" id="end" value="0" name="status" checked>
                            </c:if>
                            <c:if test="${detail.status ne 0}">
            ...
            <div class="form-group mt-3">
                ...
                <input type="date" name="sdate" id="sdate" class="form-control" placeholder="시작일 지정해주세요" value="${detail.sdate}" autocomplete="off" required>
            </div>
            <div class="form-group mt-3">
                <label class="edate">종료일</label>
                <input type="date" name="edate" id="edate" class="form-control" placeholder="종료일 지정해주세요" value="${detail.edate}" autocomplete="off" required>
            </div>
            <div class="form-group mt-3">
