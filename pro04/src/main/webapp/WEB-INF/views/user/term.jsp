            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="banner_content text-center">
                        ...
                        <div class="page_link">
                            <a href="${path}/"> Home </a>
                            <a href="${path}/user/term"> Sign Up </a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="columns is-desktop is-justify-content-center">
            <div class="column is-8-desktop">
                <div class="p-5 bg-white shadow" style="margin: 150px auto;">
                    <h2> 약관 동의 </h2>
                    <hr>
                    <div class="form-group form-check mt-3">
                        <input type="checkbox" class="form-check-input" id="ck_item_all" name="ck_item" onclick="protocol()">
                        <label for="ck_item_all" class="mb-0">
                            회원가입 약관에 모두 동의합니다
                        </label>
                    </div>
                    <hr>
...
③ 법 시행 전에 개인정보를 수집한 개인정보처리자는 기존의 수집목적 범위에도 불구하고 제1항 단서 및 제2항을 준수하기 위하여 새롭게 정보주체의 동의를 받을 목적으로 법 시행 전에 수집한 개인정보를 이용할 수 있다.
                    ...
                    <div class="text-right">
                        <button class="btn btn-primary btn-lg" id="in_btn1"> 다음 단계 </button>
                    </div>
                </div>
            </div>
        </div>
